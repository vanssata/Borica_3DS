...
class Boorica
{
    ...
    /** Терминал ИД който банка са дали */
    private $terminal_id;
    ...
    /** Линка на който се изпраща формата за тестова среда */
    private $test_action = 'https://3dsgate-dev.borica.bg/cgi-bin/cgi_link';
    /**
     * Линка на който се изпраща формата за реална среда
    ...
    function generateBoricaRequestFieldsForTRTYPE_1()
    {
        ...
        $amount = 22;
        //Коректен формат на стойноста на проъчката e xxx.xx два десетични символа задължително примерно 22.00
